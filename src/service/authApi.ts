...
// 회원가입 요청
export async function signupRequest(email: string, password: string, name: string, gender: string): Promise<any> {
  try {
...
// 이메일 중복 확인 요청
export async function checkEmailRequest(email: string): Promise<any> {
  try {
